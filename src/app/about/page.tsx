        ...
        <div className="container max-w-4xl mx-auto px-4 space-y-20">
          ...
          <div className="text-center space-y-8 animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            <div className="space-y-4">
              <h1 className="text-3xl md:text-5xl font-black tracking-tight text-zinc-900 font-rounded uppercase">
                {t('title')}
              </h1>
              <p className="text-zinc-500 font-medium text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                {t('subtitle')}
              </p>
            </div>
          ...
          <Card className="border-none shadow-2xl shadow-zinc-200/50 rounded-[3rem] p-10 md:p-16 bg-white overflow-hidden relative group">
             ...
             <div className="relative z-10 space-y-6">
                <h2 className="text-xl font-black uppercase tracking-widest text-primary font-rounded">Our Mission</h2>
          ...
          <div className="space-y-12">
            <div className="flex items-center gap-4 px-4">
              ...
              <h2 className="text-2xl font-black text-zinc-900 tracking-widest uppercase font-rounded">{t('historyTitle')}</h2>
            </div>
