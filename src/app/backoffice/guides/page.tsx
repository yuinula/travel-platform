...
export default function ManageGuidesPage() {
  ...
  const [editingGuide, setEditingLandmark] = useState<Guide | null>(null)
    ...
    <div className="space-y-10">
              ...
              <CardContent className="p-6 flex flex-col md:flex-row md:items-center gap-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs font-medium">{guide.email}</p>
                  </div>
                </div>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="bg-zinc-900 border-zinc-800 text-white max-w-2xl p-10 rounded-[3rem] shadow-2xl">
          <DialogHeader>
            <DialogTitle className="text-3xl font-black uppercase font-rounded tracking-widest">Edit Guide Profile</DialogTitle>
            <DialogDescription className="text-zinc-500">Update professional details for <span className="text-white font-bold">{editingGuide?.name}</span></DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6 mt-8">
            ...
            <div className="grid grid-cols-2 gap-6">
               ...
               <div className="space-y-2">
                 ...
                 <Input type="number" value={formData.hourly_rate} onChange={e => setFormData({...formData, hourly_rate: parseInt(e.target.value)})} className="bg-zinc-800 border-zinc-700 rounded-xl" />
               </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
               <Button 
                ...
                variant="outline" 
                className={cn(
                  "rounded-xl border-zinc-700 h-10 px-4 font-bold text-xs gap-2",
          ...
          <DialogFooter className="mt-10">
            <Button onClick={handleUpdateGuide} className="w-full h-16 rounded-2xl ai-gradient font-black text-lg shadow-xl shadow-primary/20">
