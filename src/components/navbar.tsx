      ...
      <div className="container flex h-16 items-center justify-between mx-auto px-4">
        <div className="flex items-center gap-4 md:gap-10">
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent side="left" className="w-[300px] p-0 overflow-y-auto">
              <SheetHeader className="p-6 text-left border-b bg-zinc-50/50">
                <SheetTitle className="font-bold text-xl tracking-tighter flex items-center gap-2 font-rounded ai-text-gradient">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <span className="inline-block font-bold text-xl tracking-tighter font-rounded ai-text-gradient">
              {t('title')}
            </span>
          </Link>
